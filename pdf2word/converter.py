...
class PDFToWordConverter:
    ...
    def __init__(self, ocr_engine: str = "tesseract", ocr_lang: str = "fra+eng",
                 enhance: bool = True, mode: str = "auto", dpi: int = 300):
        """
        Args:
            ...
            mode: Conversion mode — 'auto' (default), 'text', 'ocr', or 'hybrid'.
    ...
    def convert(self, input_pdf: str, output_docx: str,
        ...
        enhanced = False
        if self.enhance and method not in ("hybrid", "combined", "smart", "msword", "libreoffice"):
